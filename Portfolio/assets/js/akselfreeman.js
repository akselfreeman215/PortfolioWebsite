...
var particleCount = 80,
  ...
  lineWidth = 3,
  linkChance = 90, // chance per frame of link, higher = smaller chance
  ...
  renderMesh = false,
  flicker = true,
  flickerSmoothing = 25, // higher = smoother flicker
  blurSize = 0,
  orbitTilt = true,
  randomMotion = true,
  noiseLength = 1000,
...
Particle.prototype.render = function() {
  ...
  if (renderParticleGlare) {
    ...
    context.closePath();
    */
    context.ellipse(pos.x, pos.y, r * glareLength, r, (glareAngle - ((nPos.x - 0.5) * noiseStrength * motion)) * (Math.PI / 180), 0, 2 * Math.PI, false);
    context.fill();
    context.closePath();
  }
